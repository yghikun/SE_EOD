...
`metadata_scope_v1.json` is the current metadata boundary for metadata residual
analysis.
...
The scope gate exists to keep residual analysis from becoming a general cleanup
