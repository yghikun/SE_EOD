...
DEFAULT_CANDIDATES_IN = "outputs/suspicious_candidates.csv"
DEFAULT_DEEPSEEK_TRUE_CANDIDATES_OUT = "outputs/deepseek_true_candidates.jsonl"
DEFAULT_PROTOCOLS_DIR = "configs/resource_protocols"
DEFAULT_RANKED_CANDIDATES_OUT = "outputs/ranked_candidates.jsonl"
DEFAULT_CANDIDATES_WITH_EVIDENCE_OUT = "outputs/candidates_with_evidence.csv"
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--out",
        default="outputs/ext4_error_paths.csv",
    ...
    parser.add_argument(
        "--candidates-out",
        default="outputs/suspicious_candidates.csv",
    ...
    parser.add_argument(
        "--llm-tasks-out",
        default="outputs/llm_review_tasks.jsonl",
    ...
    parser.add_argument(
        ...
        default="outputs/deepseek_reviews.jsonl",
