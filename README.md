...
当前 v7.1 全量扫描 triage 为：8 条 review，6 条 likely false positive，2 条
needs external semantics，0 条 needs protocol instance，0 条直接进入 manual bug
review。两个 ext4 replay bookkeeping helper 的源码形状可疑，但还缺少独立语义契约；
它们不能仅凭待检查源码升级为协议或 bug。
