...
DEFAULT_RANKED = "outputs/linux-v6.8/ext4/ranked_candidates.jsonl"
DEFAULT_TASKS = "outputs/linux-v6.8/ext4/llm_review_tasks.jsonl"
DEFAULT_QUEUE_JSONL = "outputs/linux-v6.8/ext4/manual_review_queue.jsonl"
DEFAULT_QUEUE_MD = "outputs/linux-v6.8/ext4/manual_review_queue.md"
DEFAULT_LABEL_TEMPLATE = "outputs/linux-v6.8/ext4/manual_review_labels_todo.jsonl"
...
def write_queue_md(items: list[dict[str, Any]], path: str | Path) -> None:
    ...
    lines = [
        ...
        "Copy completed labels into `outputs/linux-v6.8/ext4/manual_review_labels.jsonl`.",
        "",
